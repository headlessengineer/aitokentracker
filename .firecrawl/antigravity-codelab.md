[Skip to main content](https://codelabs.developers.google.com/getting-started-google-antigravity#main-content)

[![Google Codelabs](https://www.gstatic.com/devrel-devsite/prod/v63ff991b83776932202eabe7967909a8dae574de15846bab934768a76bf6c589/codelabs/images/lockup.svg)](https://codelabs.developers.google.com/)

`/`

Language

- [English](https://codelabs.developers.google.com/getting-started-google-antigravity)
- [Deutsch](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=de)
- [Español](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=es)
- [Español – América Latina](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=es-419)
- [Français](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=fr)
- [Indonesia](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=id)
- [Italiano](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=it)
- [Polski](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=pl)
- [Português – Brasil](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=pt-br)
- [Tiếng Việt](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=vi)
- [Türkçe](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=tr)
- [Русский](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=ru)
- [עברית](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=he)
- [العربيّة](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=ar)
- [فارسی](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=fa)
- [हिंदी](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=hi)
- [বাংলা](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=bn)
- [ภาษาไทย](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=th)
- [中文 – 简体](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=zh-cn)
- [中文 – 繁體](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=zh-tw)
- [日本語](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=ja)
- [한국어](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=ko)

[![Google Codelabs](https://www.gstatic.com/devrel-devsite/prod/v63ff991b83776932202eabe7967909a8dae574de15846bab934768a76bf6c589/codelabs/images/lockup.svg)](https://codelabs.developers.google.com/)

- On this page
- [Introduction](https://codelabs.developers.google.com/getting-started-google-antigravity#0)
- [Installation](https://codelabs.developers.google.com/getting-started-google-antigravity#1)
- [Installing Antigravity](https://codelabs.developers.google.com/getting-started-google-antigravity#installing-antigravity)
- [Install Antigravity IDE](https://codelabs.developers.google.com/getting-started-google-antigravity#install-antigravity-ide)
- [Antigravity Interface](https://codelabs.developers.google.com/getting-started-google-antigravity#2)
- [Projects](https://codelabs.developers.google.com/getting-started-google-antigravity#projects)
- [Conversations](https://codelabs.developers.google.com/getting-started-google-antigravity#conversations)
- [Project Settings](https://codelabs.developers.google.com/getting-started-google-antigravity#project-settings)
- [Slash Commands](https://codelabs.developers.google.com/getting-started-google-antigravity#3)
- [Scheduling Commands](https://codelabs.developers.google.com/getting-started-google-antigravity#4)
- [Model Context Protocol (MCP) Servers](https://codelabs.developers.google.com/getting-started-google-antigravity#5)
- [Artifacts](https://codelabs.developers.google.com/getting-started-google-antigravity#6)
- [Antigravity IDE](https://codelabs.developers.google.com/getting-started-google-antigravity#7)
- [Skills](https://codelabs.developers.google.com/getting-started-google-antigravity#8)
- [Structure and Scope](https://codelabs.developers.google.com/getting-started-google-antigravity#structure-and-scope)
- [The Anatomy of a Skill](https://codelabs.developers.google.com/getting-started-google-antigravity#the-anatomy-of-a-skill)
- [Code Review Skill](https://codelabs.developers.google.com/getting-started-google-antigravity#code-review-skill)
- [Conclusion](https://codelabs.developers.google.com/getting-started-google-antigravity#9)
- [Earn your Kaggle 5-Day AI Agents badge](https://codelabs.developers.google.com/getting-started-google-antigravity#earn-your-kaggle-5-day-ai-agents-badge)
- [Reference docs](https://codelabs.developers.google.com/getting-started-google-antigravity#reference-docs)
...
[_close_](https://codelabs.developers.google.com/) [_menu_](https://codelabs.developers.google.com/getting-started-google-antigravity#)

# [Getting Started with Google Antigravity](https://codelabs.developers.google.com/getting-started-google-antigravity)

_access\_time_ 55 mins remaining

Language

- [English](https://codelabs.developers.google.com/getting-started-google-antigravity#0)
- [Deutsch](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=de#0)
- [Español](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=es#0)
- [Español – América Latina](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=es-419#0)
- [Français](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=fr#0)
- [Indonesia](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=id#0)
- [Italiano](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=it#0)
- [Polski](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=pl#0)
- [Português – Brasil](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=pt-br#0)
- [Tiếng Việt](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=vi#0)
- [Türkçe](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=tr#0)
- [Русский](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=ru#0)
- [עברית](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=he#0)
- [العربيّة](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=ar#0)
- [فارسی](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=fa#0)
- [हिंदी](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=hi#0)
- [বাংলা](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=bn#0)
- [ภาษาไทย](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=th#0)
- [中文 – 简体](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=zh-cn#0)
- [中文 – 繁體](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=zh-tw#0)
- [日本語](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=ja#0)
- [한국어](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=ko#0)

_access\_time_ 55 mins remaining

01. [Introduction](https://codelabs.developers.google.com/getting-started-google-antigravity#0)
02. [Installation](https://codelabs.developers.google.com/getting-started-google-antigravity#1)
03. [Antigravity Interface](https://codelabs.developers.google.com/getting-started-google-antigravity#2)
04. [Slash Commands](https://codelabs.developers.google.com/getting-started-google-antigravity#3)
05. [Scheduling Commands](https://codelabs.developers.google.com/getting-started-google-antigravity#4)
06. [Model Context Protocol (MCP) Servers](https://codelabs.developers.google.com/getting-started-google-antigravity#5)
07. [Artifacts](https://codelabs.developers.google.com/getting-started-google-antigravity#6)
08. [Antigravity IDE](https://codelabs.developers.google.com/getting-started-google-antigravity#7)
09. [Skills](https://codelabs.developers.google.com/getting-started-google-antigravity#8)
...
_subject_ Last updated Jun 26, 2026

_account\_circle_ Written by Romin Irani & Mete Atamel
...
[Back](https://codelabs.developers.google.com/getting-started-google-antigravity# "Previous step")
...
[Next](https://codelabs.developers.google.com/getting-started-google-antigravity# "Next step") [Done](https://codelabs.developers.google.com/ "Codelab complete")

[_bug\_report_ Report a mistake](https://github.com/googlecodelabs/feedback/issues/new?title=[getting-started-google-antigravity])
...
[![Google Developers](https://www.gstatic.com/devrel-devsite/prod/v63ff991b83776932202eabe7967909a8dae574de15846bab934768a76bf6c589/codelabs/images/lockup-google-for-developers.svg)](https://developers.google.com/)
...
- [Manage cookies](https://codelabs.developers.google.com/getting-started-google-antigravity#)
